	...
	API.addPOI = function(_poi) {
		...
		if(API.checkInstall()) {
			if(typeof _poi === "object") {
				if((typeof _poi.lat === "undefined" || typeof _poi.lon === "undefined") && typeof _poi.addr === "undefined") {
					...
					if(typeof _poi.lat !== "undefined" && typeof _poi.lon !== "undefined") {
						appURL += "ll=" + _poi.lat + "," + _poi.lon;
					}
					
					if(typeof _poi.address !== "undefined") {
						appURL += "&addr=" + _poi.address;
					}
					
					if(typeof _poi.radiusKM !== "undefined") {
						appURL += "&radKM=" + _poi.radiusKM;
					}
					
					if(typeof _poi.radiusMI !== "undefined") {
						appURL += "&radML=" + _poi.radiusMI;
					}
					
					if(typeof _poi.title !== "undefined") {
						appURL += "&title=" + _poi.title;
					}
					
					if(typeof _poi.text !== "undefined") {
						appURL += "&text=" + _poi.text;
					}
					
					if(typeof _poi.tel !== "undefined") {
						appURL += "&tel=" + _poi.tel;
					}
					
					if(typeof _poi.callbackURL !== "undefined") {
